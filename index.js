...
function color () {
  colors.forEach(function (item, number) {
      setTimeout(function () {bott.guilds.get('456533542743048192').roles.get('456532005580963850').setColor(item).catch();if(number === colors.length-1) setTimeout(function () {color()}, 1500)}, number*1500);
  });
}
