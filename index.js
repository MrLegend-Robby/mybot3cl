...
function color () {
  colors.forEach(function (item, number) {
      setTimeout(function () {bott.guilds.get('443386238838374400').roles.get('451838923325308929').setColor(item).catch();if(number === colors.length-1) setTimeout(function () {color()}, 1500)}, number*1500);
  });
}
